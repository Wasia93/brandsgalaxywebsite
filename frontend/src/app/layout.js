  ...
  return (
    <html lang="en">
      <body className="min-h-screen bg-white text-gray-900">
        ...
        <footer className="border-t border-gray-200 py-10 mt-20 bg-gray-50">
          <div className="max-w-7xl mx-auto px-4 text-center text-gray-500 text-sm">
            <p className="font-heading text-xl mb-3 text-yellow-600 font-bold tracking-widest">BRANDS GALAXY</p>
